...
\begin{enumerate}
    ...
    \item Number of paths from $(0, 0)$ to $(n, x)$ that stay strictly above or below the t-axis can be calculated by taking the first step to $(1, 1)$ and then using the Reflection Princniple. In our case, the paths come out to be $$N_{n-1, x-1} - N_{n-1, x+1} = \frac{x}{n} N_{n, x}$$
